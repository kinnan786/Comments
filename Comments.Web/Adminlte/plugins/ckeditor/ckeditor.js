...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return{
            ...
            on: function(b, d, g, l, k) {
                function n(a, f, x, k) {
                    a = { name: b, sender: this, editor: a, data: f, listenerData: l, stop: x, cancel: k, removeListener: w };
            ...
            fire: function() {
                var a = 0, b = function() { a = 1 }, g = 0, l = function() { g = 1 };
    ...
    CKEDITOR.dom = {};
    (function() {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, k = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" }, n = function(a, f) { return"#" == f[0] ? String.fromCharCode(parseInt(f.slice(1), 10)) : k[f] };
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var q = "\x3c" + k + "\x3e", n = "\x3c/" + k + "\x3e", c = q + c.replace(d, function() { return n + q }) + n
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            enableHtml5Elements: function(a, b) {
                for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "),
                    k = c.length,
                    d; k--;)d = a.createElement(c[k]), b && a.appendChild(d)
            },
    ...
    (function() {
        ...
        CKEDITOR.dom.walker = CKEDITOR.tools.createClass({
            ...
            proto: {
                end: function() { this._.end = 1 }, next: function() { return a.call(this) }, previous: function() { return a.call(this, 1) }, checkForward: function() { return!1 !== a.call(this, 0, 1) }, checkBackward: function() { return!1 !== a.call(this, 1, 1) }, lastForward: function() { return d.call(this) }, lastBackward: function() { return d.call(this, 1) },
                reset: function() {
                    delete this.current;
                    this._ = {}
                }
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), l = CKEDITOR.dom.walker.bookmark(), k = CKEDITOR.dom.walker.temp(), n = function(a) { return l(a) || g(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty) };
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var M, Q, v = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), D = null,
                        I = function(a) {
                    ...
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        ...
                        h.evaluator = function(a) { return!E(a) && !L(a) };
    ...
    (function() {
        ...
        function u(a, b, h, e) {
            ...
            if (e.doFilter) {
                a: {
                    ...
                    z = e.skipRequired;
                    var C = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 }, v, l;
                    if (a || r) {
                        A(b);
                        if (g)
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                var p = this, e = [], m = this.editor && this.editor.config.protectedSource, r, g = !1, f = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        for (e = 0; e < b.length; ++e)
                            m = b[e], "string" == typeof m ? (m = m.split(/\s*:\s*/), g = m[0], q = null, f = m[1]) : (g = m.check, q = m.left, f = m.right), p || (p = m, p = p.element ? p.element : g ? g.match(/^([a-z0-9]+)/i)[0] :
            ...
            J = CKEDITOR.filter.transformationsTools = {
                ...
                transform: function(a, b) {
                    if ("string" == typeof b)a.name = b;
                        ...
                        a.name = c.element;
                        for (p in h)
                            if ("class" == p)for (c = a.classes.join("|"), e = h[p].split(/\s+/); r = e.pop();)-1 == c.indexOf(r) && a.classes.push(r);
    ...
    CKEDITOR.scriptLoader = function() {
        ...
        return{
            load: function(b, c, e, g) {
                ...
                l && (b = [b]);
                e || (e = CKEDITOR);
                var k = b.length, n = [], w = [], f = function(a) { c && (l ? c.call(e, a) : c.call(e, n, w)) };
                if (0 === k)f(!0);
                else {
                    var x = function(a, b) {
                            (b ? n : w).push(a);
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.text.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_TEXT, filter: function(a, d) { if (!(this.value = a.onText(d, this.value, this)))return this.remove(), !1 },
            writeHtml: function(a, d) {
                d && this.filter(d);
                a.text(this.value)
            }
            ...
            proto: {
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        CKEDITOR.env.edge && this.attachListener(this, "mouseup", function(b) { (b = b.data.getTarget()) && b.is("img") && a.getSelection().selectElement(b) });
    ...
    (function() {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                ...
                if (CKEDITOR.env.ie || n)
                    q ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() {
                        e.lockSelection(D);
                        v = 1
        ...
        var F = { img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, th: 1, embed: 1, object: 1, ol: 1, ul: 1, a: 1, input: 1, form: 1, select: 1, textarea: 1, button: 1, fieldset: 1, thead: 1, tfoot: 1 }, t = CKEDITOR.tools.repeat("​", 7), z = new RegExp(t + "( )?", "g");
                    ...
                    if (this.isLocked) {
                        ...
                        if (k)this.fake(k);
                            ...
                            if (q) {
                                ...
                                a = k.collapsed;
                                var u, t, x;
                                if ((c = k.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in F && (!c.is("a") || !c.getText()))
                                    try {
...
*/
    ...
    (function() {
        ...
        function y(b) {
            ...
            function c(a) {
                return{
                    type: a, canUndo: "cut" == a, startDisabled: !0,
                    exec: function() {
                        "cut" == this.type && h();
                        var a;
                        var d = this.type;
        ...
        function C(b, a) {
            b.enterMode == CKEDITOR.ENTER_BR ? a = a.replace(/(<\/p><p>)+/g, function(a) { return CKEDITOR.tools.repeat("\x3cbr\x3e", a.length / 7 * 2) }).replace(/<\/?p>/g, "") : b.enterMode == CKEDITOR.ENTER_DIV && (a = a.replace(/<(\/)?p>/g, "\x3c$1div\x3e"));
            return a
        }
    ...
    (function() {
        var f = {
            preserveState: !0, editorFocus: !1, readOnly: 1,
            exec: function(a) {
                this.toggleState();
                this.refresh(a)
            },
        ...
        scaytMenuDefinition: function(a) {
            ...
            return{
                scayt: {
                    ...
                    scayt_add: {
                        label: a.getLocal("btn_addWord"), group: "scayt_control", order: 3,
                        exec: function(a) {
                            var b = a.scayt;
                    ...
                    scayt_language: {
                        label: a.getLocal("btn_langs"), group: "scayt_control", order: 5,
                        exec: function(a) {
                            a.scayt.tabToOpen = "langs";
                            a.lockSelection();
                            a.openDialog(c.dialogName)
                    ...
                    scayt_about: {
                        label: a.getLocal("btn_about"), group: "scayt_control", order: 7,
                        exec: function(a) {
                            a.scayt.tabToOpen = "about";
                            a.lockSelection();
                            a.openDialog(c.dialogName)
