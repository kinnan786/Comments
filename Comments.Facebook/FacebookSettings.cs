namespace Comments.Facebook
{
    ...
    {
        public static string Url { get; } = "https://graph.facebook.com/v2.8/";
        public static string ClientId { get; } = "1684083165235754";
        public static string ClientSecret { get; } = "8acfa62510d5f4e671e898c1d45c5cf2";
        ...
        public static string[] stopwords =
        {
            ...
            "away", "be", "became", "because", "become", "becomes", "becoming", "been", "before",
            "beforehand",  "being", "believe", "below", "beside", "besides", "best", "better", "between",
            "beyond", "both", "brief", "but", "by", "c’mon", "c’s", "came", "can", "can’t", "cannot", "cant", "cause",
            ...
            "couldn’t", "course", "currently",  "described",  "did", "didn’t", "different", "do",
            ...
            "everybody", "everyone", "everything", "everywhere", "ex",  "example", "except", "far", "few",
            ...
            "got", "gotten", "had", "hadn’t",  "has", "hasn’t", "have", "haven’t",
            ...
            "however", "i’d", "i’ll", "i’m", "i’ve", "ie", "if", "in", "inasmuch", "inc",
            "indeed", "indicate", "indicated", "indicates", "inner", "insofar", "instead", "into", "inward", "is",
            "isn’t", "it", "it’d", "it’ll", "it’s", "its", "itself", "just", "keep", "keeps", "kept", "know", "knows",
            "known", "last", "lately", "later", "latter", "latterly", "least", "less", "lest", "let", "let’s",
            "likely", "ltd", "mainly", "many", "may", "maybe", "me",
            ...
            "now", "nowhere", "of", "off", "often", "old", "on", "once", "one", "ones",
            ...
            "possible", "presumably", "probably", "provides", "que",  "qv", "rather", "rd", "re", "really",
            ...
            "sometime", "sometimes", "somewhat", "somewhere", "soon", "specified", "specify", "specifying",
            ...
            "took", "toward", "towards", "tried", "tries", "truly", "try", "trying", "twice", "two", "un", "under",
             "unless",  "until", "unto", "up", "upon", "us", "use", "used", "useful", "uses",
            "using", "usually", "value", "various", "very", "via", "viz", "vs", "want", "wants", "was", "wasn’t", "way",
            "we", "we’d", "we’ll", "we’re", "we’ve",  "well", "went", "were", "weren’t", "what", "what’s",
            ...
            "yourselves", "zero","i","a","didnt","im","dont","youre","doesnt"
        };
