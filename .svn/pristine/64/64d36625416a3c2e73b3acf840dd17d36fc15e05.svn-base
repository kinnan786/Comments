            ...
            utils: {
                ...
                resolveList: function(a) {
                    ...
                    if ((b = a.removeAnyChildWithName("cke:listbullet")) && b.length && (b = b[0]))
                        return a.name = "cke:li", c.style && (c.style = H.filters.stylesFilter([
                ...
                flattenList: function(a, c) {
                    ...
                    for (var d = a.children, e, k = 0; k < d.length; k++)
                        if (e = d[k], e.name in CKEDITOR.dtd.$listItem) {
                            ...
                            H.filters.stylesFilter([["tab-stops", null, function(a) { (a = a.match(/0$|\d+\.?\d*\w+/)) && (x = CKEDITOR.tools.convertToPx(a[0])) }], 1 == c ? ["mso-list", null, function(a) {
                                        a = a.split(" ");
                ...
                assembleList: function(a) {
                    ...
                    for (q = 0; q < a.length; q++)
                        if (l = a[q], u = l.children, g = g = void 0, y = l.children.length,
                            ...
                            for (k = 0; k < y; k++)
                                if (g = u[k], g.attributes.value && Number(g.attributes.value) == k + 1 && delete g.attributes.value, g = c.exec(g.attributes.style))
                                    if (g[1] != v && v) {
                                        v = null;
                                        break
                                    } else v = g[1];
                ...
                return{
                    ...
                    elements: {
                        ...
                        p: function(a) {
                            if (/MsoListParagraph/i.exec(a.attributes["class"]) ||
                                ...
                                var b = a.firstChild(function(a) { return a.type == CKEDITOR.NODE_TEXT && !q(a.parent) });
                    ...
                    attributes: {
                        style: l(w ? [
                            ...
                            ], [/^margin$/, G], ["text-indent", "0cm"], ["page-break-before"], ["tab-stops"], ["display", "none"], r ? [/font-?/] : null
                        ], w),
                        width: function(a, c) { if (c.name in b.$tableContent)return!1 },
                        border: function(a, c) { if (c.name in b.$tableContent)return!1 },
                        "class": function(a, b) { return b.classWhiteList && -1 != b.classWhiteList.indexOf(" " + a + " ") ? a : !1 },
                        bgcolor: k,
